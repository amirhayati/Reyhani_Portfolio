    ...
    const drawer = (
        <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
            ...
            <List>
                ...
                >
                    <li className='header_link'><a to={"/"} >Home</a></li>
                    <li className='header_link'><a to={"/About"} >About</a></li>
                    <li className='header_link'><a to={"/Portfolio"} >Portfolio</a></li>
                    <li className='header_link'><a to={"/Contact"} >Contact</a></li>
                    <li className='header_link'><a to={"/Blog"} >Blog</a></li>
                </Box>
            </List>
            <Btn>Download CV</Btn>
        </Box>
